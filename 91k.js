document.write('<style> .modown-ad img{width:100%;} @media only screen and (min-width:0px) and (max-width:980px){.bottom_fixed{ position:fixed; bottom:0px; width:100%; z-index:9999;} .bottom_fixed div{ width:30px; height:30px; text-align:center; line-height:30px; background:#CCC; right:0; top:-30px; position:absolute; cursor:pointer;}.bottom_fixed div:hover{ background:#F66; color:#FFF}.bottom_fixed a img{ width:100%;} .max30h { max-height:28px !important; } .max170h { max-height:170px !important; }} .topwz{margin-top:8px;}  .topwz{margin-top: 10px;line-height: 30px;} .topwz span{font-weight: bold;margin-right: 10px;font-size:16px;} .topwz a {font-size: 16px;margin-right: 19px;display: inline-block;white-space: nowrap;} .topwz a:last-child {margin: 0px;}</style>');
...
/*
var arr = [{"link":"https://www.x2682.com:5443?register=1","img":"https://78dx8t.com/d39458b107e1422e8b38a67255b58744.gif"},{"link":"https://t4112.com:6443?register=1","img":"https://u0062.com/e6b8be1ecdb1417e95f72d081104bd59.gif"},{"link":"https://v34581.com:7443?register=1","img":"https://j872jd.com/51676facfd7245648f7c38d1ad1459e8.gif"}];
//arr.sort(randomsort);
for(key in arr)
{
	$('.modown-ad').append('<a href="'+arr[key].link+'" rel="external nofollow" target="_blank"><img  src="'+arr[key].img+'"></a>');
}
*/
$('.modown-ad').append(''+
...
'<a href="https://v2770.com:8663" rel="external nofollow" target="_blank"><img  src="https://3337253.com/73f312afd5a14c94b3155c87de9ebb3d.gif"></a>'+
...
'<a href="https://www.2006008.com/?channelCode=057" rel="external nofollow" target="_blank"><img  src="https://www.pg4444.com//tuku/nmbj960x240.gif"></a>'+
'');
...
'<a href="https://楼凤阁.com/?aff=91k" target="_blank">楼凤阁小姐信息</a>'+
'</div>');
