document.write('<style> .modown-ad img{width:100%;} @media only screen and (min-width:0px) and (max-width:980px){ .max30h { max-height:28px !important; } .max170h { max-height:170px !important; }}</style>');
